  ...
  public: {
    Tables: {
      ...
      compliance_verifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "compliance_verifications_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      practice_information: {
        Row: {
          created_at: string | null
          id: string
          number_of_practitioners: number | null
          number_of_support_staff: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "practice_information_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
